# [HTML5 Blank](http://emc.com)

Powerful shell for rapidly deploying your WordPress projects.

* Project: [github.com/toddmotto/emc](https://github.com/toddmotto/emc)
* Website: [emc.com](http://emc.com)
* Twitter: [@emc](http://twitter.com/emc)
...
* In CLI, run: `git clone https://github.com/toddmotto/emc.git`
* `cd emc` and then `npm install` and then `bower install` (you'll need gulp install as well)
...
* NOTE: `src` and `dist` folders can live happily together inside the same folder (`emc`) that in the `theme` folder. You'll have two different instances of the theme within `Appearance > Themes` panel inside the admin


## Get involved! Make HTML5 Blank better

There are a few ways to get involved, submit a Pull Request, or submit a comment on the website - [emc.com](http://emc.com)
...
## Contributors
Thanks to all the awesome [contributors](https://github.com/toddmotto/emc/graphs/contributors)!
